# О проекте
**Стек:** ASP.NET Core Web API, Postgres, Entity Framework, AutoMapper, REST Api

Проект представляет собой Web API спроектированый по RESTFUL-методологии, 
предоставляющий доступ к такой информации как клиенты, продукты, поставщики, изображения товаров и адресса поставщиков/клиентов. 

В качетсве базы данных использовался Postgres и доступ к ней через Entity Framework. 

Для правильного доступа к данным в реализации использовались паттерны Data Access Object (DAO) и Data Transfer Object (DTO).
